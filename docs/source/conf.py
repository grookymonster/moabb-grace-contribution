...
# Only suppress warnings that genuinely cannot be fixed at source:
# underscore-prefixed private base classes (cannot be documented publicly),
# and numpydoc type-annotation artifacts (default values, shape descriptors).
nitpick_ignore = [
    # Private base classes (underscore-prefixed, cannot be public API)
    ("py:class", "moabb.datasets.dreyer2023._Dreyer2023Base"),
    ("py:class", "moabb.datasets.compound_dataset.bi_illiteracy._base_bi_il"),
    ("py:class", "moabb.datasets.huebner_llp._BaseVisualMatrixSpellerDataset"),
    # Internal modules/classes not in the public API docs
    ("py:mod", "moabb.datasets.utils"),
    ("py:mod", "moabb.datasets.preprocessing"),
    ("py:mod", "moabb.analysis"),
    ("py:mod", "moabb.analysis.neural_signatures"),
    ("py:mod", "moabb.paradigms"),
    ("py:class", "moabb.datasets.preprocessing.SetRawAnnotations"),
    ("py:class", "moabb.datasets.preprocessing.RawToEpochs"),
    ("py:class", "moabb.datasets.preprocessing.FixedPipeline"),
    ("py:class", "moabb.datasets.bids_interface.BIDSInterfaceRawEDF"),
    ("py:class", "moabb.datasets.bids_interface.BIDSInterfaceBase"),
    ("py:class", "moabb.evaluations.splitters.LearningCurveSplitter"),
    ("py:obj", "moabb.datasets.compound_dataset.utils.compound_dataset_list"),
    # Functions in internal modules not in public API docs
    ("py:func", "moabb.analysis.neural_signatures.generate_neural_signature"),
    ("py:func", "moabb.analysis.neural_signatures.neural_signature_html"),
    ("py:func", "moabb.analysis.neural_signatures.get_plotly_template"),
    ("py:func", "moabb.analysis.neural_signatures.get_plotly_colorscale"),
    ("py:func", "moabb.analysis.results.get_string_rep"),
    ("py:func", "moabb.analysis.chance_level.chance_by_chance"),
    ("py:func", "chance_by_chance"),
    ("py:func", "moabb.datasets.preprocessing.make_fixed_pipeline"),
    ("py:func", "moabb.datasets.utils.plot_all_datasets"),
    ("py:func", "moabb.datasets.bnci.MNEBNCI.data_path"),
    ("py:func", "moabb.utils.verbose"),
    ("py:func", "moabb.pipelines.utils.create_pipeline_from_config"),
    ("py:func", "moabb.pipeline.utils_pytorch.BraindecodeDatasetLoader"),
    # References using wrong role (:func: for classes)
    ("py:func", "moabb.paradigms.FakeSSVEPParadigm"),
    ("py:func", "moabb.paradigms.FakeP300Paradigm"),
    ("py:func", "moabb.paradigms.FakeImageryParadigm"),
    ("py:func", "moabb.datasets.BaseDataset"),
    ("py:func", "moabb.datasets.fake"),
    ("py:func", "moabb.datasets.thielen2021"),
    # Typos in existing references (in old changelog entries)
    ("py:class", "moabb.evaluation.WithinSessionEvaluation"),
    ("py:class", "moabb.evaluation.CrossSessionEvaluation"),
    ("py:class", "moabb.evaluation.CrossSubjectEvaluation"),
    # Wrong module path references
    ("py:class", "moabb.datasets.Mainsah2025"),
    ("py:class", "moabb.datasets.BaseCastillos2023"),
    ("py:class", "moabb.datasets.ErpCore2021"),
    ("py:meth", "moabb.datasets.base.BaseDataset.convert_to_bids"),
]
nitpick_ignore_regex = [
    # numpydoc parses default values as type references (unfixable at source)
    (r"py:class", r"default.*"),
    (r"py:class", r"optional"),
    # numpydoc shape descriptors in type annotations
    (r"py:class", r"of shape.*"),
    (r"py:class", r"n_\w+"),
    (r"py:class", r"length \d+"),
    # Boolean/numeric literals parsed as types by numpydoc
    (r"py:class", r"True"),
    (r"py:class", r"False"),
    (r"py:class", r"\d+\.?"),
    # numpydoc shape descriptors
    (r"py:class", r"shape"),
    # numpydoc free-text type descriptions
    (r"py:class", r"array-like"),
    (r"py:class", r"numeric"),
    (r"py:class", r"RandomState instance"),
    (r"py:class", r"cross-validation class"),
    (r"py:class", r"dataset instance"),
    (r"py:class", r"Dataset instance"),
    (r"py:class", r"Paradigm instance"),
    ...
    (r"py:class", r'"raise"'),
    # Sentence fragments parsed as types by numpydoc
    (r"py:class", r"storage location.*"),
    (r"py:class", r"sklearn-compatible.*"),
    (r"py:class", r"save_to_file=.*"),
    (r"py:class", r"path is"),
    (r"py:class", r"log_level=.*"),
    (r"py:class", r"pipeline instance.*"),
    (r"py:class", r"for now"),
    (r"py:class", r"and .*"),
    (r"py:class", r"a warning.*"),
    (r"py:class", r"a compatible.*"),
    (r"py:class", r"The new.*"),
    (r"py:class", r"If"),
    (r"py:class", r"DOI.*"),
    (r"py:class", r"CodeCarbon.*"),
    (r"py:class", r"SSVEP_\w+ object"),
    (r"py:class", r"CCA object"),
    (r"py:class", r"Axes"),
    (r"py:class", r"Path"),
    (r"py:class", r".*\*.*"),
    (r"py:class", r"list with.*"),
    (r"py:class", r"'p300'"),
    (r"py:class", r"'imagery'"),
    (r"py:class", r"'ssvep'"),
    (r"py:class", r"id"),
    (r"py:class", r'"Target"'),
    (r"py:class", r'"NonTarget"'),
    (r"py:class", r"length.*"),
    (r"py:class", r"Dataset"),
]
